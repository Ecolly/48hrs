...
fakenames_staffs_key = [0, 1, 2, 3, 7, 8, 10, 12, 13, 14, 16, 17, 19, 22, 23, 26]
fakenames_tomes_key = [0, 1, 2, 3, 7, 8, 10, 12, 13, 14, 16, 17, 19, 22, 23, 26]
...
fakenames_tomes_realnames = ("Tome of Recovery", "Tome of Injury", "Tome of Promotion", "Tome of Demotion", "Immunity Tome", "Paperskin Tome", "Sharpening Tome", "Fortifying Tome", "Staffboost Tome", "Tome of Consolidation", "Tome of Dispersion", "Coloring Tome", "Summoning Tome", "Banishing Tome", "Tome of Pizzazz", "Bankruptcy Tome")
